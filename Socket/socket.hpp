...
public:
    ...
    bool send(const string &destinationIP, int32_t destinationPort, void *data, uint32_t size);
    void sendSegment(const Segment &segment, const string &destinationIP, uint16_t destinationPort);
